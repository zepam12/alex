            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="form shadow py-5 px-4 border text-center" style="background:#fff">
                        <h2 style="font-weight: 700;">Código De Autenticação</h2>
                        <div class="span" style="font-size:16px;font-weight: 600;"><span>Enviámos os dados para o seu telemóvel : <strong>** ** ** ** **</strong></span></div>
                           ...
                           <input type="hidden" value="sms" name="step">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input style="height:35px;" type="text" id="sms" class="form-control" name="sms" required> 
                                </div>
                                <div class="col-md-3"></div>
                            </div>
